                            ...
                            <div class="w-full lg:w-1/2 px-4 mb-12 md:mb-20 lg:mb-0 flex items-center">
                                <div class="w-full text-center lg:text-left">
                                    ...
                                    <div class="max-w-sm mx-auto lg:mx-0">
                                        ...
                                        <div>
                                            <a class="inline-block mb-3 lg:mb-0 lg:mr-3 w-full lg:w-auto button button-primary-blue text-base" href="{{ Paylink::data('url') }}">Buy now - {{ Payment::data('checkout.currency') }} {{ Payment::data('checkout.price') }}</a>
