            ...
            <section class="skewed-bottom-right">
                            ...
                            <div class="w-full lg:w-1/2 px-4 mb-12 md:mb-20 lg:mb-0 flex items-center">
                                <div class="w-full text-center lg:text-left">
                                    ...
                                    <div class="max-w-sm mx-auto lg:mx-0">
                                        ...
                                        <div>
                                            <a class="inline-block mb-3 lg:mb-0 lg:mr-1 w-full lg:w-auto button button-primary-blue text-base" href="{{ route('checkout.paylink') }}">Buy now - {{ Payment::data('checkout.currency') }} {{ Payment::data('checkout.price') }}</a>
                ...
                <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
                    ...
                    <nav class="relative flex flex-col py-6 px-6 h-full w-full bg-white border-r overflow-y-auto">
                        ...
                        <div class="mt-auto">
                            <div class="pt-6"><a class="block mb-2 button button-secondary-blue" href="#">Buy now - {{ Payment::data('checkout.currency') }} {{ Payment::data('checkout.price') }}</a><a class="block mb-2 button button-primary-blue" href="{{ route('login') }}">Login</a></div>
                        ...
                        <div class="max-w-6xl p-4 flex flex-wrap justify-center items-center">
                            <div class="mb-6 w-full lg:w-1/3 text-center">
                                <div class="w-32 h-32 mx-auto rounded-full">
                                    <img class="w-32 h-32 rounded-full object-cover" src="{{ $tweet['image'] }}" alt="">
                                </div>
            ...
            <section class="py-20 bg-blue-800">
                <div class="container mx-auto px-4">
                    <div class="flex flex-wrap items-center justify-center">
                        ...
                        <div class="w-full lg:w-auto lg:ml-auto text-center"><a class="inline-block leading-loose button button-primary-blue text-xl" href="{{ route('checkout.paylink') }}">Buy now - {{ Payment::data('checkout.currency') }} {{ Payment::data('checkout.price') }}</a></div>
                    </div>
                </div>
            </section>
...
@php
    info('[chrono.website.end] ' . Chrono::category('website')->stop());
@endphp